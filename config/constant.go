...
const API_ERR_CODE_FAIL_TO_GET_APP_LIST = 4010500
const API_ERR_CODE_FAIL_TO_UPSERT_APP = 4010501
const API_ERR_CODE_FAIL_TO_DELETE_APP = 4010502
const API_ERR_CODE_FAIL_TO_GET_APP_DETAIL = 4010503
